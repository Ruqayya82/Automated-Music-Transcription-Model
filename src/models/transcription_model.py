...
from .pitch_onset_cnn import create_model
...
class TranscriptionModel:
    ...
    def __init__(self, config: dict, device: str = 'cpu'):
        ...
        model_config['input_dim'] = audio_config['n_mels']
        self.model = create_model(model_config)
        self.model.to(self.device)
        
        logger.info(f"Initialized TranscriptionModel on {device}")
    ...
    def transcribe_audio(self, audio_path: str, 
        ...
        Args:
            ...
            use_model: Use ML model if True, use traditional methods otherwise
    ...
    def transcribe(self, audio_path: str, 
                  use_model: bool = True) -> Tuple[list, Dict]:
        """
        Full transcription pipeline
        
        Args:
            audio_path: Path to audio file
            use_model: Use ML model if True
